...
namespace FlutterUnityIntegration.Editor
{
    public class Build : EditorWindow
    {
        ...
        private static readonly string FlutterPath = Path.GetFullPath(Path.Combine(ProjectPath, "../../"));
        private static readonly string AndroidExportPath = Path.GetFullPath(Path.Combine(FlutterPath, "android/unityLibrary"));
        private static readonly string IOSExportPath = Path.GetFullPath(Path.Combine(FlutterPath, "ios/UnityLibrary"));
        private static readonly string WebExportPath = Path.GetFullPath(Path.Combine(FlutterPath, "web/UnityLibrary"));
        private static readonly string IOSExportPluginPath = Path.GetFullPath(Path.Combine(FlutterPath, "ios_xcode/UnityLibrary"));
